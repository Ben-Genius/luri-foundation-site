        ...
        <div className="max-w-[95rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
            <SplitHeading
              ...
              className="text-4xl font-extrabold text-white md:text-6xl max-w-2xl"
            />
            <Reveal delay={0.1}>
              <p className="text-white/60 text-base font-medium leading-relaxed max-w-sm md:text-right">
              ...
              <Reveal key={v.title} delay={i * 0.06} className={v.colSpan}>
                <div
                  className={[
                    v.minH,
                    v.hover,
                    "h-full rounded-xl  border border-white/10 p-7 flex flex-col justify-between",
                ...
                >
                  ...
                  <div>
                    <h3 className="ed-title text-xl md:text-2xl mb-2 text-white">{v.title}</h3>
